...
public class BusinessLogicImpl implements BusinessLogic {
    ...
    public Ride startRide(StartRideDTO startRideDTO)
        ...
        if (storage.find(USERS, startRideDTO.userId().id(), User.class).isEmpty()) {
            throw new NotFoundException("No user with id " + startRideDTO.userId().id() + " was found to start a ride");
        }
        ...
        try {
            ...
            throw new FatalErrorException("A randomly generated UUID for a new ride collided with existing ride", e);
        }
        return ride;
    }
